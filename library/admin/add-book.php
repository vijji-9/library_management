...
<!-- MENU SECTION END-->
<div style="background-image:url('https://th.bing.com/th/id/OIP.dg5p1jwtl8tglHJ87ecIbwHaE8?pid=ImgDet&rs=1'); background-repeat: no-repeat;
  ...
  background-size: 100% 100%;">
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line" style="color:black; font-weight:900;">Add Book</h4>
