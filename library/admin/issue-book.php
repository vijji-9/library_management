...
<!-- MENU SECTION END-->
<div style="background-image:url('https://thumbs.dreamstime.com/b/giving-stack-books-22272806.jpg'); background-repeat: no-repeat;
  ...
  background-size: 100% 100%;">
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line" style="color:black">Issue a New Book</h4>
