...
<!-- MENU SECTION END-->
<div style="background-image:url('https://th.bing.com/th/id/OIP.NV5n99m5O7i6wf93VI-O0gHaCj?pid=ImgDet&rs=1'); background-repeat: no-repeat;
  ...
  background-size: 100% 100%;">
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line" style="color:black">Manage Authors</h4>
    </div>
     <div class="row">
